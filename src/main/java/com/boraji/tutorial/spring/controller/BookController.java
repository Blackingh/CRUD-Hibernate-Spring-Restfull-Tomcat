...
public class BookController {
	...
	public ResponseEntity<Book> getBook(
			@ApiParam(value = "El ID del libro a buscar", required = true) @PathVariable("id") long id) {
	...
	public ResponseEntity<Book> updateBook(
			@ApiParam(value = "El ID del libro a actualizar", required = true) @PathVariable("id") long id,
	...
	public ResponseEntity<?> deleteBook(
			@ApiParam(value = "El ID del libro a eliminar", required = true) @PathVariable("id") long id) {
